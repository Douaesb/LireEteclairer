                ...
                @foreach ($categories as $categorie)
                    <div
                        ...
                        <div class="flex justify-between gap-6 pt-2 ">
                            ...
                            <button id="editButton" type="button" data-category-name="{{ $categorie->name }}" data-category-id="{{ $categorie->id }}" data-modal-target="popup-modal" data-modal-toggle="popup-modal">
                                            ...
                                            <g id="edit">
                                                <g>
                                                    ...
                                                    <polygon fill="none"
                                                        ...
                                                        stroke="#cbd5e1" stroke-linecap="round"
                            ...
                            <form action="{{ route('categorie.destroy', $categorie->id) }}" method="POST">
                                ...
                                <button type="submit">
                                    <svg width="30px" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <path d="M10 12V17" stroke="#cbd5e1" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M14 12V17" stroke="#cbd5e1" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M4 7H20" stroke="#cbd5e1" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path

...
<body>
    <div class="flex m-auto bg-yellow-900 justify-center items-center h-[100vh]">
        <div class="grid md:grid-cols-2 grid-cols-1 p-16 bg-amber-400 md:w-3/5 md:h-3/5 mb-4">
            ...
            <div class="w-full flex flex-col justify-center items-center">
                ...
                <div class="flex flex-col gap-3 h-full justify-center">
                    <div class="flex justfiy-center flex-col">
                        <h1 class="font-[Inter] text-4xl font-semibold flex w-full justify-center text-center"> Create an account
                        </h1>
                    </div>

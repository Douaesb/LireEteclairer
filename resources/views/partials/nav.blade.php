<header>
    <nav class="flex justify-between md:justify-evenly items-center bg-yellow-900 h-16 px-4 lg:px-10">
        ...
        <!-- End of Burger menu -->
        <div id="nav-links" class="hidden text-lg md:text-xl absolute end-4 top-12 md:relative flex md:flex-row md:top-0 flex-col lg:flex md:bg-yellow-900 bg-amber-400 p-3 md:mt-0 md:text-white md:gap-6 justfiy-center rounded-lg border-2 border-yellow-900 font-semibold font-[inter]">
                @guest

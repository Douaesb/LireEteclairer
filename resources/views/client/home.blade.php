...
<body class="bg-yellow-900">
            ...
            <ul class="lg:flex gap-6 text-white list-none ">
                ...
                <li>
                    <button id="basket" class="relative hidden md:block">
                        ...
                        <div class="hidden md:flex absolute top-0.5 left-7 text-xs text-yellow-900 font-bold">{{$numProductsInBasket}}</div>
                    </button>
                </li>
            </ul>
            {{-- </div> --}}
    ...
    <section class="bg-white">
        <div class="p-10">
            ...
            <div class="flex justify-center max-w-sm overflow-hidden bg-white rounded-lg shadow-md my-6 dark:bg-gray-800" x-data="{show : true}" x-init="setTimeout(()=> show = false , 3000)"
                x-show="show">
                <div class="flex items-center justify-center w-12 bg-amber-400">
                    <svg fill="#713f12" class="w-6 h-6 text-white fill-current" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="panier" class="hidden relative z-10" aria-labelledby="slide-over-title" role="dialog"
                aria-modal="true">
                <!--
                                                            ...
                                                            <div class="ml-4 flex flex-1 flex-col">
                                                                <div>
                                                                    <div
                                                                        ...
                                                                        <h3>
                                                                            <a href="#">{{substr($article->titre,0,25)}}</a>
                                                                        </h3>
                                                                        <p class="ml-4"> Total:{{ $article->pivot->quantity * $article->price }} $</p>
                                                                    </div>
                                                                    <p class="mt-1 text-sm text-gray-500">price per piece : {{ $article->price }}$</p>
                                                                </div>
                                                                <div
                                                                    class="flex flex-1 items-end justify-between text-sm">
                                                                    <p class="text-gray-500">Quantity : {{ $article->pivot->quantity }}</p>

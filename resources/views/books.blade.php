        ...
        <div class="p-10">
            ...
            <div
                ...
                @foreach ($bookData as $book)
                    <div
                        class="article-container card shadow-lg flex flex-col w-4/5 justify-evenly items-center pb-4 gap-6">
                        <div class="picture bg-slate-100 w-full flex justify-center">
                            @if ($book->photo && filter_var($book->photo, FILTER_VALIDATE_URL))
                                <img class="pic" src="{{ $book->photo }}" alt="Book Image">
                            @elseif($book->photo && !filter_var($book->photo, FILTER_VALIDATE_URL))
                                <img class="pic" src="{{ asset('storage/' . $book->photo) }}" alt="Book Image">
                            @else
